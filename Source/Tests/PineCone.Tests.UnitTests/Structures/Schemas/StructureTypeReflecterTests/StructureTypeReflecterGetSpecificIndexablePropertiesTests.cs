...
namespace PineCone.Tests.UnitTests.Structures.Schemas.StructureTypeReflecterTests
{
    ...
    public class StructureTypeReflecterGetSpecificIndexablePropertiesTests : StructureTypeReflecterTestsBase
    {
        ...
        {
            var ex = Assert.Throws<ArgumentException>(() => ReflecterFor().GetSpecificIndexableProperties(typeof(WithStructureId), false, null));
        ...
        {
            var ex = Assert.Throws<ArgumentException>(() => ReflecterFor().GetSpecificIndexableProperties(typeof(WithStructureId), false, new string[] { }));
        ...
        {
            var properties = ReflecterFor().GetSpecificIndexableProperties(typeof(WithStructureId), false, new[] { "StructureId" });
        ...
        {
            var properties = ReflecterFor().GetSpecificIndexableProperties(typeof(WithStructureId), false, new[] { "Int1" });
        ...
        {
            var properties = ReflecterFor().GetSpecificIndexableProperties(typeof(WithStructureId), false, new[] { "Bytes1" });
        ...
        {
            var properties = ReflecterFor().GetSpecificIndexableProperties(typeof(WithStructureId),false, new[] { "Bool1" });
        ...
        {
            var properties = ReflecterFor().GetSpecificIndexableProperties(typeof(WithStructureId), false, new[] { "Nested", "Nested.Int1OnNested" });
